...
function Row({
  ...
  return (
    ...
    >
      <span className="font-display mt-0.5 w-6 shrink-0 text-sm text-white/25 transition-colors duration-300 group-hover:text-white/60">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1 text-[14px] leading-relaxed text-white/40">{detail}</p>
      </div>
    </li>
  );
}
