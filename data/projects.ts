...
const PROJECT_ENTRIES: Project[] = [
  ...
  },
  {
    ...
    clientLogo: "/logos/joveo.png",
    summary:
      "Five career-site templates for five industries. Upload a knowledge base, pick a shape, and the site fills itself in, a two-to-three day build closes in minutes.",
    role: "Product Designer",
    period: "2026",
    tools: ["Figma", "Next.js"],
    intro: [
      "Joveo's CMS is self-serve, so most clients building a career site have never opened a design file. Smart Templates designs the starting point instead: five cohesive, industry-specific sites that already look like a designer made them, because one did.",
      "Each template arrives already knowing who the client is, by the time a user picks one, their knowledge base is uploaded, so brand, copy, imagery and live job data pour straight in.",
    ],
    cover: "/projects/smart-templates/cover.png",
    blocks: [],
  },
  {
    slug: "rain-mazha",
